...
Promise.all([util.promisify(fs.readFile)("contributors.json", 'utf-8'),
  ...
  .then(([contributors, repos, bots, wgrepos]) => {
    ...
    const processRepos = [/^w3ctag\//, /w3c\/w3process/, /w3c\/transitions/, /w3c\/AB/, /w3c\/charter-timed-text/, /w3c\/strategy/, /w3c\/wg-effectiveness/, /w3c\/echidna/, /w3c\/spec-generator/, /w3c\/tr-design/, /w3c\/specberus/, /team-strat/, /w3c\/test-results/, /w3c\/modern-tooling/];
