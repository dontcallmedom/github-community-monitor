...
Promise.all([util.promisify(fs.readFile)("contributors.json", 'utf-8'),
  ...
  .then(([contributors, repos, bots, wgrepos]) => {
    ...
    const siteRepos = [/w3c\/wai-website/, /w3c\/web-roadmaps/, /w3c\/tr-pages/, /w3c\/wai-roles-responsbilities/, /w3c\/wai-bcase/, /w3c\/wai-policies-prototype/, /w3c\/wai-wcag-quickref/];
